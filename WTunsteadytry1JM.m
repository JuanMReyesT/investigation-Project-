...
Power_vector=zeros(1,time_steps);
Power_thrust=zeros(1,time_steps);
Power_Torque=zeros(1,time_steps);
Time=zeros(1,time_steps);
% % init W factors
% % initialization 
for o=1:42
[RES,NMO]=fBEMUnsteady(WT,Sim,Wind,Algo,NMO,x,v,p);
psi=psi+Omega*At;
x=[0,psi];
end
psi=0;
...
Power_vector(o)=Total_Power;
Power_thrust(o)=Total_Thrust;
Power_Torque(o)=Total_Torque;
t=t+At;
WT.tt=0.2*sin(10*t);
p=2*cos(10*t);
end
plot(Time,Power_Torque)